...
@receiver(m2m_changed, sender=NewsArticle.postCategory.through)
...
#             msg = EmailMultiAlternatives(
#                 subject=instance.name,
#                 body=f'Здравствуй, {usr.first_name} {usr.last_name}. Новая статья в твоём любимом разделе!'+instance.news_text,  #  это то же, что и message
#                 from_email='volko.ina@yandex.ru',
#                 to=[f'{usr.email}'],  # это то же, что и recipients_list
#             )
#             msg.attach_alternative(html_content, "text/html")  # добавляем html
